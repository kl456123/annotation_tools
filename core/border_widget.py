...
class BorderWidget(vtk.vtkBorderWidget):
    ...
    def SetPosition(self):
        ...
        representation.SetPosition2(self.abs_end[0] / size[0] - tmp[0],
                                    self.abs_end[1] / size[1] - tmp[1])
    ...
    def RegisterCallBack(self, displayer):
        from annotation_tools.callbacks.border_widget_callback import BorderWidgetCallback
